...
namespace ProjectEuler.Tests
{
    public class Problem6Tests
    {
        ...
        {
            Assert.Equal(expected, Problem6.Lib.SumSquareDifference(input));
        }
        ...
        public void TestSumofSquares(long expected) =>
            Assert.Equal(expected, Problem6.Lib.getSquareOfSum(getTestSet()));

        [Theory]
        [InlineData(18)]
        public void TestSquaresum(long expected) =>
            Assert.Equal(expected, Problem6.Lib.getSumOfSquares(getTestSet()));
